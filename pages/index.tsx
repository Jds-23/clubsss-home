...
<div className='w-full fixed p-4 bg-black flex justify-between'>
  ...
  <a href='https://discord.gg/CraUtnzK' target="_blank" rel="noopener noreferrer" className=' px-5 text-sm py-2 flex justify-center font-bold rounded-md justify-self-end w-fit cursor-pointer '>Discord</a>
  <a href='https://twitter.com/_clubsss' target="_blank" rel="noopener noreferrer" className=' px-5 text-sm py-2 flex justify-center font-bold rounded-md justify-self-end w-fit cursor-pointer '>Twitter</a>
